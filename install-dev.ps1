# Install the chiron CLI from the DEV channel (Windows).
#
...
#
#   & ([scriptblock]::Create((irm <RAW_URL>/install-dev.ps1))) -Code CHIR-… -Server <url>
#
...
Write-Host "-> chiron CLI - DEV channel"
$env:CHIRON_CHANNEL = "dev"
